    ...
    return (
        <div className=" flex justify-between items-center w-screen h-20 bg-ColorHeaderBackground">
            ...
            <div className="flex justify-center items-center ">
                <div className="flex justify-center items-center fill-white w-8 h-8 mt-7">
                    <svg
                ...
                <div className="flex justify-center items-center bg-ColorStatusConnectionOnline w-16 h-16 m-5 rounded-md">
                    <svg
                        className="fill-white w-14 h-14"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 512 512"
                    >
