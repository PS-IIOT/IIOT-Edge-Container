...
# Frage: Soll es einen Datahandler geben
# oder:
# Pro TCP connection wird ein neuer Datahandler erzeugt
class Datahandler:
    ...
    def conversion(self,timestamp):
        conv_json_object = self.data_converter.conversion(timestamp, self.que.popleft())
        ...
        # FIXME: store data into Database, so Flask can access it
